          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
            ...
            <div className="border-b border-gray-100 last:border-b-0">
              ...
              <SmoothCollapse isOpen={openFaq === 2}>
                <div className="px-5 pb-4 leading-relaxed text-gray-500 text-sm font-medium">
                  We use a Protected Funds system. Once a job is successfully completed and confirmed by the employer, funds are released directly to your requested bank account via your BukieBrain wallet.
                </div>
              </SmoothCollapse>
            </div>
