    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#001A41]/65 p-4" role="dialog" aria-modal="true" aria-labelledby="location-notice-title">
      <section className="relative w-full max-w-md space-y-5 rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-2xl sm:p-8">
        ...
        <div className="space-y-2">
          <p className="text-[10px] font-bold uppercase tracking-wider text-amber-800">Service locations</p>
          <h3 id="location-notice-title" className="font-display text-xl font-bold text-[#0B1C30]">Find services in {location.name}</h3>
          <p className="text-sm leading-relaxed text-slate-600">Explore services that fit the work you need done in {location.name}, {location.state}.</p>
          <p className="text-sm leading-relaxed text-slate-600">Choose a location to find services near you.</p>
        </div>
