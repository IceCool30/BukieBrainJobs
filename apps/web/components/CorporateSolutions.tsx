        ...
        <div className="bg-slate-50 rounded-xl p-8 sm:p-12 border border-slate-200 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="space-y-4 max-w-xl">
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              For estate managers, facility teams, and business owners: centralize your maintenance operations on one platform and provide your tenants or employees with a streamlined request system.
            </p>
