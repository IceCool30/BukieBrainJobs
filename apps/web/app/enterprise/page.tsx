  ...
  return (
    <main className="min-h-screen bg-[#F8F9FF] text-[#001A41]">
      <section className="relative isolate overflow-hidden bg-[#001A41] text-white">
        ...
        />
        <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(0,26,65,0.98)_0%,rgba(0,26,65,0.9)_52%,rgba(0,26,65,0.76)_100%)]" />
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top_right,rgba(171,238,200,0.14),transparent_48%)]" />

        <div className="mx-auto max-w-[1280px] px-4 pb-16 pt-6 sm:px-6 sm:pb-20 lg:px-8">
          <header className="flex min-h-11 items-center justify-between gap-4">
            <Link
              href="/"
              className="font-display text-base font-bold tracking-tight text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ABEEC8] focus-visible:ring-offset-2 focus-visible:ring-offset-[#001A41]"
            >
              BukieBrainJobs
            </Link>
            <Link
              href="/services"
              className="motion-press inline-flex min-h-11 items-center gap-2 rounded-xl border border-white/25 bg-white/5 px-4 text-sm font-bold text-white transition-colors hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ABEEC8]"
            >
              Explore services
          ...
          <div className="mt-14 grid gap-10 lg:mt-20 lg:grid-cols-[minmax(0,1.15fr)_minmax(300px,0.72fr)] lg:items-end lg:gap-16">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-5 font-display text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-[3.5rem] lg:leading-[1.08]">
            ...
            <aside className="rounded-2xl border border-white/15 bg-[#06152B]/80 p-5 shadow-[0_20px_45px_rgba(0,0,0,0.18)] sm:p-6">
              ...
              <Link
                href="/services"
                className="motion-press mt-5 inline-flex min-h-11 items-center gap-2 text-sm font-bold text-[#ABEEC8] transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ABEEC8]"
              >
                Browse services now
