---
name: ui-ux-pro-max
description: "UI/UX design intelligence for web, mobile, and desktop interfaces. Use when designing, building, reviewing, or fixing pages, components, design systems, accessibility, responsive layout, typography, color, charts, interaction, animation, or stack-specific UI implementation. Includes searchable local guidance and deterministic search scripts."
---

# UI/UX Pro Max - Design Intelligence

Searchable local UI/UX guidance covers styles, product patterns, palettes, typography, UX guidelines, icons, motion, charts, landing-page structures, performance, and technology stacks.
...
The search script is bundled with this installed skill. Invoke it by its absolute path so the command works from any project directory:

```bash
python3 /home/ubuntu/skills/ui-ux-pro-max/scripts/search.py "<query>" --domain <domain>
```

Use `python3` and do not rely on Claude Code plugin variables or the current working directory. The script requires Python 3.x and has no external dependencies.
...
```bash
python3 /home/ubuntu/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python3 /home/ubuntu/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python3 /home/ubuntu/skills/ui-ux-pro-max/scripts/search.py "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```
...
```bash
python3 /home/ubuntu/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <stack>
```
...
python3 /home/ubuntu/skills/ui-ux-pro-max/scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"

# Step 3: supplement
python3 /home/ubuntu/skills/ui-ux-pro-max/scripts/search.py "keyboard focus modal" --domain ux

# Step 4: stack guidelines
python3 /home/ubuntu/skills/ui-ux-pro-max/scripts/search.py "suspense streaming bundle" --stack nextjs
```
